        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="galeria.php"><i class="fa fa-fw fa-picture-o"></i> Galeria</a></li>
                    <li class="active"><a href="configuracoes.php"><i class="fa fa-fw fa-wrench"></i> Configurações</a></li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            </nav>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Início <small>Estatísticas do Google Analytics</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i> Início
                            </li>
                        </ol>
                    </div>
                </div>
